-- 02_seed.sql — Datos de ejemplo mínimos
\set ON_ERROR_STOP on
-- SET search_path TO clinic, public;

-- Pacientes (solo id, nombre, apellidos)
...
-- Tomamos 3 ids para crear citas asociadas
WITH p AS (
  SELECT id, nombre FROM paciente ORDER BY created_at ASC LIMIT 3
)
